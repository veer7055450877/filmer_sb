  ...
  return (
    <div className="w-full h-full absolute inset-0 z-10 pointer-events-none md:pointer-events-auto">
      ...
      >
        ...
        <Sparkles count={80} scale={12} size={2} speed={0.4} opacity={0.5} color="#d4af37" />
