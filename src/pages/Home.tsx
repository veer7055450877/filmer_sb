...
import { awards, faqItems, services, stats, tools, workflowSteps } from '../data';
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    innerControls.start({ opacity: 1, scale: 1, transition: { delay: 0.2, duration: 0.5 } });
  ...
  return (
    <div className="overflow-hidden">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl lg:text-9xl font-bold text-white font-serif mb-6 leading-tight tracking-tight drop-shadow-2xl">
              ...
              <span className="relative inline-block">
                ...
                <span className="relative text-white/50 bg-clip-text bg-gradient-to-b from-gold-300 via-gold-500 to-gold-700">STORIES</span>
              </span>
            </h1>

            <p className="text-gray-300 text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed font-light">
              Transforming raw footage into emotional masterpieces.
              Specializing in weddings, commercials, and high-impact social content.
            </p>
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-6 relative z-30">
              <Link to="/contact" className="relative z-30">
                <Button size="lg" className="shadow-[0_0_20px_rgba(212,175,55,0.3)] hover:shadow-[0_0_40px_rgba(212,175,55,0.6)] border-gold-500">
                  Start Project
                </Button>
              </Link>
              <Link to="/portfolio" className="relative z-30">
                <Button variant="outline" size="lg" className="backdrop-blur-sm bg-white/5 border-white/20 hover:bg-white/10">
                  View Portfolio
                </Button>
              </Link>
            </div>
      ...
      <section className="py-10 border-y border-white/5 bg-black/50 backdrop-blur-sm">
        <ParallaxText baseVelocity={-2}>Cinematic • Emotional • Timeless • Creative •</ParallaxText>
      </section>
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, i) => (
              ...
              >
                <h3 className="text-4xl md:text-5xl font-bold text-gold-500 font-serif mb-2">{stat.value}</h3>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="relative rounded-xl overflow-hidden aspect-video group cursor-pointer border border-white/10 shadow-[0_0_50px_rgba(0,0,0,0.5)]">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8 bg-gradient-to-t from-black via-black/80 to-transparent">
              <h3 className="text-3xl font-bold text-white font-serif mb-2">2025 Showreel</h3>
              <p className="text-gray-300">Experience the magic of storytelling</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-1/2">
              <span className="text-gold-500 font-bold tracking-[0.2em] uppercase text-sm mb-4 block">Featured Project</span>
              <h2 className="text-4xl md:text-5xl font-bold text-white font-serif mb-6">The Alpine Elopement</h2>
              <p className="text-gray-400 text-lg leading-relaxed mb-8">
                A breathtaking journey into the mountains. We captured the raw emotion of two souls uniting amidst the clouds.
                From drone shots of the peaks to the intimate whispers of vows, this film represents our signature style.
              </p>
              <div className="flex gap-4">
                <div className="px-4 py-2 bg-white/5 rounded text-xs uppercase tracking-wider text-gray-300">Wedding</div>
                <div className="px-4 py-2 bg-white/5 rounded text-xs uppercase tracking-wider text-gray-300">Cinematic</div>
                <div className="px-4 py-2 bg-white/5 rounded text-xs uppercase tracking-wider text-gray-300">4K</div>
              </div>
              <div className="mt-8">
                <Link to="/portfolio" className="text-gold-500 font-bold uppercase tracking-wider hover:text-white transition-colors inline-flex items-center gap-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <SpotlightCard>
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-white mb-4 font-serif">Fast Turnaround</h3>
                <p className="text-gray-400 text-sm leading-relaxed">
                  We understand the excitement. Get your teasers within days and full films on schedule, without compromising quality.
                </p>
              </div>
            </SpotlightCard>
            ...
            <SpotlightCard>
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-white mb-4 font-serif">Cinematic Quality</h3>
                <p className="text-gray-400 text-sm leading-relaxed">
                  4K editing, professional color grading, and sound design that rivals feature films. Your story deserves the best.
                </p>
              </div>
            </SpotlightCard>
            ...
            <SpotlightCard>
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-white mb-4 font-serif">Creative Vision</h3>
                <p className="text-gray-400 text-sm leading-relaxed">
                  We don't just document; we create art. Every cut is intentional, every transition smooth and meaningful.
                </p>
              </div>
            </SpotlightCard>
          </div>
      ...
      <section className="py-20 bg-black/40 border-y border-white/5">
        <div className="container mx-auto px-6 text-center">
          <p className="text-gray-500 text-sm uppercase tracking-widest mb-8">Powered by Industry Standard Tools</p>
          <div className="flex flex-wrap justify-center gap-8 md:gap-16 opacity-70">
            {tools.map((tool, i) => (
              <div key={i} className="flex flex-col items-center gap-3 group hover:opacity-100 transition-opacity">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-8 relative">
            ...
            {workflowSteps.map((step, i) => (
              ...
              >
                ...
                <h4 className="text-lg font-bold text-white font-serif mb-2">{step.title}</h4>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {services.map((service, index) => (
              ...
              >
                ...
                <Link to="/services" className="inline-flex items-center text-gold-500 text-sm font-bold uppercase tracking-wider hover:text-white transition-colors mt-auto">
      ...
      <section className="py-32 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          <h2 className="text-4xl md:text-7xl font-bold text-white font-serif mb-8">Let's Create Magic</h2>
          <p className="text-gray-400 text-lg md:text-xl max-w-2xl mx-auto mb-12">
            Ready to turn your footage into a cinematic masterpiece? Let's discuss your project.
          </p>
          <Link to="/contact">
            <Button size="lg" className="bg-gold-500 text-black hover:bg-white text-lg px-10 py-5 shadow-[0_0_30px_rgba(212,175,55,0.4)]">
              Start Your Project
            </Button>
          </Link>
        </div>
